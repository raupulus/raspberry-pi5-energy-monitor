...
- **Fuente**: Especificación técnica proporcionada por el usuario (ver archivos originales en [`src/hardware-contract.md`](src/hardware-contract.md) y [`src/energy-contract.md`](src/energy-contract.md)).
- **Fecha de descarga**: 2026-09-13 (Hardware), 2026-09-14 (Energía).
...
5. [energy.md](energy.md): Especificación detallada de endpoints del dominio `/energy` (subida y consulta de telemetría).
6. `src/`: Fuentes originales sin editar (consulta no rutinaria).
